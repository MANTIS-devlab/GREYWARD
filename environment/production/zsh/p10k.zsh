# Generated by Powerlevel10k configuration wizard on 2026-09-06 at 10:20 CEST.
...
() {
  ...
  # Keep the current-directory segment present and do not proactively shorten it.
  # Powerlevel10k may still shorten it as a last resort when the prompt cannot fit.
  ...
  # Show the current user in every shell, without adding the hostname.
